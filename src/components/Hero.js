                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            {/* We build digital solutions to help businesses scale */}
                                Bespoke solutions built around your needs, not off-the-shelf templates.
                            </h1>
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">We build modern websites, apps, software, and blockchain solutions for growing businesses.
From idea to launch, we turn bold visions into real digital products.</div>
